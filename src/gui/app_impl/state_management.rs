use crate::gui::state::{FrequencyUnit, PeriodUnit, WorkspaceTimingTab};
use crate::gui::workspace_model::WorkspaceSettings;
...
impl GuiApp {
    ...
    pub(crate) fn apply_workspace_settings(&mut self) {
        ...
        self.thread_priority = settings.thread_priority.clamp(0, 99);
        self.deadline_tolerance_ns = settings.deadline_tolerance_ns;
    ...
    pub(crate) fn current_workspace_settings(&self) -> WorkspaceSettings {
        ...
        WorkspaceSettings {
            ...
            thread_priority: self.thread_priority.clamp(0, 99),
