use crate::gui::tool_model::plugin::{is_extendable_inputs, plugin_display_name, InstalledPlugin};
use crate::gui::workspace_model::{ConnectionDefinition, ConnectionRuleError, WorkspaceDefinition};
...
pub fn add_connection(
    ...
    crate::gui::workspace_model::add_connection(&mut workspace.connections, connection, 1)?;
