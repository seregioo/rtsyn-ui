use crate::gui::daemon_bridge::plugin_creator::templates::{plugin_templates_dir, render_to_file};
use crate::gui::daemon_bridge::plugin_creator::validation::PluginLanguage;
use std::fs;
